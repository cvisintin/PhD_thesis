...
\B{\Cref{sec:6sp}}. This chapter is reproduced, in its entirety, from the accepted paper \textit{Consistent patterns of vehicle collision risk for six terrestrial mammal species}. I conceived the original ideas, developed the methods, completed all of the analyses, and wrote the first draft of the manuscript. MMC and RvdR provided editorial comments on the chapter.
...
\item Casey Visintin, Rodney van der Ree, Michael A. McCarthy (submitted) Predicting wildlife-train collisions across space and time to inform railway operations. \textit{Ecological Applications}
