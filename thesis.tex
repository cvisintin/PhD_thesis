...
\B{\Cref{sec:egk}}. This chapter is reproduced, in its entirety, from the published paper \textit{A simple framework for a complex problem?  Predicting wildlife-vehicle collisions}. MMC and I conceived the modelling ideas. I developed the methods, completed all of the analysis, and wrote the first draft of the manuscript. MMC and RvdR provided editorial comments on the chapter.

\B{\Cref{sec:6sp}}. This chapter is reproduced, in its entirety, from the accepted paper \textit{Consistent patterns of vehicle collision risk for six mammal species}. I conceived the original ideas, developed the methods, completed all of the analysis, and wrote the first draft of the manuscript. MMC and RvdR provided editorial comments on the chapter.
...
\B{\Cref{sec:val}}. I conceived the original idea through conversations with RvdR. I developed the methods, completed all of the analysis, and wrote the chapter. MMC and RvdR provided editorial comments on the chapter.

This thesis also trains and tests statistical models with datasets on species occurrence and collision events. All of these data were originally collected by several different organisations (whom also currently maintain these data). More information on these organisations is available in \Cref{apx:C}.
...
QAECO is a large group and several members have really made my tenure a special experience. Els van Burm, my long-lost Belgian twin and academic comrade, put in the long library hours with me. Michaela Plein looked after me and taught me other important life lessons like making granola and growing vegetables. Darren Southwell was kind enough to share his long list of potential interview questions and look over some my architect-turned-ecologist job applications. Hugh Davies and Matt West gave me some excellent field experience catching small mammals and frogs, respectively. To Freya, Clair, Hannah, Liz, Natasha, Gerry and Chris, thanks for being awesome. I am humbled by the talents of Jian, Jos\'e, Guru, Heini, Reid, Pia, Cindy, and Nat -- all of whom I give thanks for helping me along in this PhD journey. It has been a pleasure to sit next to Pauline Byron and Dolla Boutros who have always been super friendly and helpful. Thanks to everyone else for the great laughs and conversation during sunny lunches in the gardens.

Thanks to Dave Duncan and Belinda Ashe for hosting me in their lovely home whilst I finished the thesis. Dave lived through a thesis and provided great advice -- not to mention prepared Melbourne's finest tacos. To my family, of course, I give thanks for the support and understanding that a thesis makes one antisocial at times. And especially to my sister, Faren, thanks for coming to hear my completion talk.
