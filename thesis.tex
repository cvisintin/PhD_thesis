...
\B{\Cref{sec:egk}}. This chapter is reproduced, in its entirety, from the published paper \textit{A simple framework for a complex problem?  Predicting wildlife-vehicle collisions}. MMC and I conceived the modelling ideas. I developed the methods, completed all of the analyses, and wrote the first draft of the manuscript. MMC and RvdR provided editorial comments on the chapter.
