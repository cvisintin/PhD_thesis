...
\begin{figure*}[!t]
  \centering
  \subfloat[]{\label{egk_sdm_vars:a}\includegraphics[width=0.3\textwidth]{egk_light.png}}
  \subfloat[]{\label{egk_sdm_vars:b}\includegraphics[width=0.3\textwidth]{egk_elev.png}}
  \subfloat[]{\label{egk_sdm_vars:c}\includegraphics[width=0.3\textwidth]{egk_precdm.png}}
...
\begin{figure*}[!t]
  ...
  \begin{minipage}[t]{.25\textwidth}
  	\centering
  	\subfloat[]{\includegraphics[width=\textwidth]{egk_POPDENS.png}\label{egk_trans_vars:a}}
  	\subfloat[]{\includegraphics[width=\textwidth]{egk_INCOMEPP.png}\label{egk_trans_vars:b}}\\
  	\subfloat[]{\includegraphics[width=\textwidth]{egk_KMTOCZ.png}\label{egk_trans_vars:c}}
  	\subfloat[]{\includegraphics[width=\textwidth]{egk_KMTORZ.png}\label{egk_trans_vars:d}}\\
  	\subfloat[]{\includegraphics[width=\textwidth]{egk_KMTOHWY.png}\label{egk_trans_vars:e}}
  	\subfloat[]{\includegraphics[width=\textwidth]{egk_RDDENS.png}\label{egk_trans_vars:f}}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{.5\textwidth}
  	\centering
  	\subfloat[]{\includegraphics[width=\textwidth]{egk_RDCLASS.png}\label{egk_trans_vars:g}}  
  \end{minipage}  
