...
\begin{figure*}[!h]
  \centering
  \subfloat[]{\label{egk_effects:a}\includegraphics[height=5.2cm]{egk_fig06a.png}}
  \subfloat[]{\label{egk_effects:b}\includegraphics[height=5.2cm]{egk_fig06b2.png}}
  \subfloat[]{\label{egk_effects:c}\includegraphics[height=5.2cm]{egk_fig06c2.png}}
