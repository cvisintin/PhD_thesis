...
\begin{figure*}[!h]
  \centering
  \includegraphics[scale=.95]{egk_fig01.png}
...
\centering
\begin{tabularx}{0.9\textwidth}{@{}clY@{}} \toprule
...
\begin{figure*}[!h]
  \centering
  \includegraphics[scale=1]{egk_fig03b.png}
...
\begin{figure*}[!h]
  \centering
  \includegraphics[scale=1]{egk_fig04b.png}
...
\begin{figure*}[!h]%
  \centering%
  \subfloat[]{\includegraphics[height=5.5cm]{egk_light.png}}%
  \subfloat[]{\includegraphics[height=5.5cm]{egk_elev2.png}}%
  \subfloat[]{\includegraphics[height=5.5cm]{egk_precdm2.png}}%
...
\begin{figure*}[!h]
  \centering
  \subfloat[]{\includegraphics[width=0.32\textwidth]{egk_popdens_volume.png}\label{egk_trans_vars:a}}
  \subfloat[]{\includegraphics[width=0.32\textwidth]{egk_rddens_volume.png}\label{egk_trans_vars:b}}
  \subfloat[]{\includegraphics[width=0.32\textwidth]{egk_rdclass_volume.png}\label{egk_trans_vars:c}}\\
  \subfloat[]{\includegraphics[width=0.32\textwidth]{egk_kmtodev_volume.png}\label{egk_trans_vars:d}}
  \subfloat[]{\includegraphics[width=0.32\textwidth]{egk_kmtohwy_volume.png}\label{egk_trans_vars:e}}\\
  \subfloat[]{\includegraphics[width=0.32\textwidth]{egk_rddens_speed.png}\label{egk_trans_vars:f}}
  \subfloat[]{\includegraphics[width=0.32\textwidth]{egk_rdclass_speed.png}\label{egk_trans_vars:g}}
...
\begin{figure*}[!h]
  \centering
  \subfloat[]{\label{egk_effects:a}\includegraphics[height=5.3cm]{egk_fig06a.png}}
  \subfloat[]{\label{egk_effects:b}\includegraphics[height=5.3cm]{egk_fig06b2.png}}
  \subfloat[]{\label{egk_effects:c}\includegraphics[height=5.3cm]{egk_fig06c2.png}}
