...
\begin{figure*}[htp]
  \centering
  \includegraphics[scale=.4]{egk_SDM_VARS.png}
...
\begin{figure*}[htp]
  \centering
  \includegraphics[scale=.6]{egk_MAP_AUS.png}
...
\begin{figure*}[htp]
  ...
  \centering
  \begin{tabular}{ccc}
  \subfloat[]{\label{egk_trans_vars:a}\includegraphics[width=0.23\textwidth]{egk_POPDENS.png}} &
  \subfloat[]{\label{egk_trans_vars:b}\includegraphics[width=0.23\textwidth]{egk_INCOMEPP.png}} &
  \multirow{-3}[-3]{*}{\subfloat[]{\label{egk_trans_vars:g}\includegraphics[width=0.46\textwidth]{egk_RDCLASS.png}}}\\
  \subfloat[]{\label{egk_trans_vars:c}\includegraphics[width=0.23\textwidth]{egk_KMTOCZ.png}} &
  \subfloat[]{\label{egk_trans_vars:d}\includegraphics[width=0.23\textwidth]{egk_KMTORZ.png}} &\\
  \subfloat[]{\label{egk_trans_vars:e}\includegraphics[width=0.23\textwidth]{egk_KMTOHWY.png}} &
  \subfloat[]{\label{egk_trans_vars:f}\includegraphics[width=0.23\textwidth]{egk_RDDENS.png}} &
  \end{tabular}  
