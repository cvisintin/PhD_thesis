...
\begin{figure*}[!h]
  ...
  \centering
  \subfloat[Eastern Grey Kangaroos]{\label{cal_sac:a}\includegraphics[width=0.4\textwidth]{04_vic_coll_cor_1000.png}}
  \subfloat[Mule Deer]{\label{cal_sac:b}\includegraphics[width=0.4\textwidth]{04_cal_coll_cor_1000.png}}\\
  \subfloat[Eastern Grey Kangaroos]{\label{cal_sac:c}\includegraphics[width=0.4\textwidth]{04_vic_coll_cor_250.png}}
  \subfloat[Mule Deer]{\label{cal_sac:d}\includegraphics[width=0.4\textwidth]{04_cal_coll_cor_250.png}}
...
\begin{figure*}[!t]
  \centering
  \includegraphics[scale=.5]{04_egk_collrisk_vic2.png}\\
  \includegraphics[scale=.5]{04_deer_collrisk_cal2.png}
...
\begin{figure*}[!t]
  \captionsetup[subfloat]{farskip=-2pt,nearskip=-2pt}
  \centering
  \subfloat[Eastern Grey Kangaroos]{\label{cal_coll_effects:a}\includegraphics[width=0.35\textwidth]{04_vic_occ.png}}
  \subfloat[Mule Deer]{\label{cal_coll_effects:b}\includegraphics[width=0.35\textwidth]{04_cal_occ.png}}\\
  \subfloat[Eastern Grey Kangaroos]{\label{cal_coll_effects:c}\includegraphics[width=0.35\textwidth]{04_vic_tvol.png}}
  \subfloat[Mule Deer]{\label{cal_coll_effects:d}\includegraphics[width=0.35\textwidth]{04_cal_tspd.png}}\\
  \subfloat[Eastern Grey Kangaroos]{\label{cal_coll_effects:e}\includegraphics[width=0.35\textwidth]{04_vic_tvol.png}}
  \subfloat[Mule Deer]{\label{cal_coll_effects:f}\includegraphics[width=0.35\textwidth]{04_cal_tspd.png}}
...
\begin{figure*}[!t]
  \captionsetup[subfloat]{farskip=-2pt,nearskip=-2pt}
  \centering
  \subfloat[Eastern Grey Kangaroos]{\label{cal_occ_effects:a}\includegraphics[width=0.4\textwidth]{04_vic_light.png}}
  \subfloat[Mule Deer]{\label{cal_occ_effects:b}\includegraphics[width=0.4\textwidth]{04_cal_slope.png}}\\
  \subfloat[Eastern Grey Kangaroos]{\label{cal_occ_effects:c}\includegraphics[width=0.4\textwidth]{04_vic_elev.png}}
  \subfloat[Mule Deer]{\label{cal_occ_effects:d}\includegraphics[width=0.4\textwidth]{04_cal_light.png}}\\
  \subfloat[Eastern Grey Kangaroos]{\label{cal_occ_effects:e}\includegraphics[width=0.4\textwidth]{04_vic_green.png}}
  \subfloat[Mule Deer]{\label{cal_occ_effects:f}\includegraphics[width=0.4\textwidth]{04_cal_green.png}}
...
\begin{figure*}[!h]
  \centering
  \includegraphics[scale=.45]{04_egk_preds_vic.png}\\
  \includegraphics[scale=.45]{04_deer_preds_cal.png}
