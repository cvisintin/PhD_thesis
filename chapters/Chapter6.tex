...
\begin{figure*}[!t]
  \centering
  \subfloat[]{\label{val_effects:a}\includegraphics[width=0.35\textwidth]{06_occ.png}}
  \subfloat[]{\label{val_effects:b}\includegraphics[width=0.35\textwidth]{06_tvol.png}}
  \subfloat[]{\label{val_effects:c}\includegraphics[width=0.35\textwidth]{06_tspd.png}}
