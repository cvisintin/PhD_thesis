...
To test the effects of combining independent datasets, we fitted a collision model based on \Cref{eq:28} in \Cref{sec:egk} to all permutations of data.  We predicted collision risk from a model that regressed reported collisions on species occurrence, traffic volume and traffic speed:
