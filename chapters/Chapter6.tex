...
\begin{figure*}[!t]
  \centering
  \includegraphics[scale=.5]{06_study_area2.png}
...
To test the effects of combining independent datasets, we fitted a collision model based on \Cref{eq:28} in \Cref{sec:egk} to all permutations of data.  We predicted collision risk from a model that regressed reported collisions on species occurrence, traffic volume (linear and quadratic terms) and traffic speed:
...
\begin{figure*}[!t]
  \centering
  \subfloat[]{\label{val_effects:a}\includegraphics[height=5.75cm]{06_occ.png}}\hfill
  \subfloat[]{\label{val_effects:b}\includegraphics[trim={0.5cm 0 0 0},clip,height=5.75cm]{06_tvol.png}}\hfill
  \subfloat[]{\label{val_effects:c}\includegraphics[trim={0.5cm 0 0 0},clip,height=5.75cm]{06_tspd.png}}
...
The ability of models to discriminate between false-positive and true-positive rates of collisions were stable using different training data and validation data (\Cref{val_glm_roc}); discrimination ability did not increase as data were added to models. Among the different validation datasets, variation in the ROC scores were less than 4\% between different combinations of data used to fit models. All of the models discriminated best when validated with the City of Bendigo dataset (ROC scores of 0.85--0.87) and worst with the Western District dataset (ROC scores of 0.75--0.78). 
...
\begin{figure*}[!h]
  \centering
  \includegraphics[width=0.9\textwidth]{06_calib.png}
...
\begin{figure*}[!t]
  \centering
  \includegraphics[width=0.75\textwidth]{06_calib2.png}
...
\begin{figure*}[!t]
  \centering
  \includegraphics[width=0.9\textwidth]{06_calib_iag.png}
...
\begin{figure*}[!t]
  \centering
  \includegraphics[width=0.9\textwidth]{06_dev_iag.png}
