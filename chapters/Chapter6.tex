...
\begin{figure*}[!t]
  \centering
  \subfloat[]{\label{val_effects:a}\includegraphics[height=5.5cm]{06_occ.png}}\hfill
  \subfloat[]{\label{val_effects:b}\includegraphics[trim={0.5cm 0 0 0},clip,height=5.5cm]{06_tvol.png}}\hfill
  \subfloat[]{\label{val_effects:c}\includegraphics[trim={0.5cm 0 0 0},clip,height=5.5cm]{06_tspd.png}}
...
\begin{figure*}[!t]
  \centering
  \includegraphics[width=0.6\textwidth]{06_calib2.png}
