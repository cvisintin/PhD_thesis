...
\begin{figure*}[!t]
  ...
  \subfloat[Swamp Wallaby]{\label{6sp_occ_seas:d}\includegraphics[width=0.4\textwidth]{6sp_occ_seasons_d.png}}\\
...
\begin{figure*}[!t]
  ...
  \subfloat[Swamp Wallaby]{\label{6sp_tvol_seas:d}\includegraphics[width=0.4\textwidth]{6sp_tvol_seasons_d.png}}\\
...
\begin{figure*}[!t]
  ...
  \subfloat[Swamp Wallaby]{\label{6sp_tspd_seas:d}\includegraphics[width=0.4\textwidth]{6sp_tspd_seasons_d.png}}\\
