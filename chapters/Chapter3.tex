...
\begin{figure*}[!htb]
  \centering
  \subfloat[Eastern Grey Kangaroo]{\label{6sp_occ_preds:a}\includegraphics[width=0.5\textwidth]{6sp_EGK_preds_brt.png}}
  \subfloat[Common Brushtail Possum]{\label{6sp_occ_preds:b}\includegraphics[width=0.5\textwidth]{6sp_BTP_preds_brt.png}}\\
  \subfloat[Common Ringtail Possum]{\label{6sp_occ_preds:c}\includegraphics[width=0.5\textwidth]{6sp_RTP_preds_brt.png}}
  \subfloat[Swamp Wallaby]{\label{6sp_occ_preds:d}\includegraphics[width=0.5\textwidth]{6sp_BSW_preds_brt.png}}\\  
  \subfloat[Common Wombat]{\label{6sp_occ_preds:e}\includegraphics[width=0.5\textwidth]{6sp_WOM_preds_brt.png}}
  \subfloat[Koala]{\label{6sp_occ_preds:f}\includegraphics[width=0.5\textwidth]{6sp_KOA_preds_brt.png}}  
...
\begin{figure*}[!t]
  ...
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[width=1cm]{egk_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_egk.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[width=0.6cm]{bsw_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_bsw.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[width=0.8cm]{wom_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_wom.png}}\\
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[width=0.6cm]{koa_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_koa.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[width=0.8cm]{btp_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_btp.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[width=0.7cm]{rtp_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_rtp.png}}\\
...
\begin{figure*}[!t]
  ...
  \includegraphics[width=0.25\textwidth]{6sp_tvol_b_egk.png}
  \includegraphics[width=0.25\textwidth]{6sp_tvol_b_bsw.png}
  \includegraphics[width=0.25\textwidth]{6sp_tvol_b_wom.png}\\
  \includegraphics[width=0.25\textwidth]{6sp_tvol_b_koa.png}
  \includegraphics[width=0.25\textwidth]{6sp_tvol_b_btp.png}
  \includegraphics[width=0.25\textwidth]{6sp_tvol_b_rtp.png}\\
...
\begin{figure*}[!t]
  ...
  \includegraphics[width=0.25\textwidth]{6sp_tspd_c_egk.png}
  \includegraphics[width=0.25\textwidth]{6sp_tspd_c_bsw.png}
  \includegraphics[width=0.25\textwidth]{6sp_tspd_c_wom.png}\\
  \includegraphics[width=0.25\textwidth]{6sp_tspd_c_koa.png}
  \includegraphics[width=0.25\textwidth]{6sp_tspd_c_btp.png}
  \includegraphics[width=0.25\textwidth]{6sp_tspd_c_rtp.png}\\
...
\begin{figure*}[!t]
  \centering
  \subfloat[Eastern Grey Kangaroo]{\label{6sp_occ_seas:a}\includegraphics[width=0.45\textwidth]{6sp_occ_seasons_a.png}}\hspace{0.05\textwidth}
  \subfloat[Common Brushtail Possum]{\label{6sp_occ_seas:b}\includegraphics[width=0.45\textwidth]{6sp_occ_seasons_b.png}}\\
  \subfloat[Common Ringtail Possum]{\label{6sp_occ_seas:c}\includegraphics[width=0.45\textwidth]{6sp_occ_seasons_c.png}}\hspace{0.05\textwidth}
  \subfloat[Swamp Wallaby]{\label{6sp_occ_seas:d}\includegraphics[width=0.45\textwidth]{6sp_occ_seasons_d.png}}\\
  \subfloat[Common Wombat]{\label{6sp_occ_seas:e}\includegraphics[width=0.45\textwidth]{6sp_occ_seasons_e.png}}\hspace{0.05\textwidth}
  \subfloat[Koala]{\label{6sp_occ_seas:f}\includegraphics[width=0.45\textwidth]{6sp_occ_seasons_f.png}}
...
\begin{figure*}[!t]
  \centering
  \subfloat[Eastern Grey Kangaroo]{\label{6sp_tvol_seas:a}\includegraphics[width=0.45\textwidth]{6sp_tvol_seasons_a.png}}\hspace{0.05\textwidth}
  \subfloat[Common Brushtail Possum]{\label{6sp_tvol_seas:b}\includegraphics[width=0.45\textwidth]{6sp_tvol_seasons_b.png}}\\
  \subfloat[Common Ringtail Possum]{\label{6sp_tvol_seas:c}\includegraphics[width=0.45\textwidth]{6sp_tvol_seasons_c.png}}\hspace{0.05\textwidth}
  \subfloat[Swamp Wallaby]{\label{6sp_tvol_seas:d}\includegraphics[width=0.45\textwidth]{6sp_tvol_seasons_d.png}}\\
  \subfloat[Common Wombat]{\label{6sp_tvol_seas:e}\includegraphics[width=0.45\textwidth]{6sp_tvol_seasons_e.png}}\hspace{0.05\textwidth}
  \subfloat[Koala]{\label{6sp_tvol_seas:f}\includegraphics[width=0.45\textwidth]{6sp_tvol_seasons_f.png}}
...
\begin{figure*}[!t]
  \centering
  \subfloat[Eastern Grey Kangaroo]{\label{6sp_tspd_seas:a}\includegraphics[width=0.45\textwidth]{6sp_tspd_seasons_a.png}}\hspace{0.05\textwidth}
  \subfloat[Common Brushtail Possum]{\label{6sp_tspd_seas:b}\includegraphics[width=0.45\textwidth]{6sp_tspd_seasons_b.png}}\\
  \subfloat[Common Ringtail Possum]{\label{6sp_tspd_seas:c}\includegraphics[width=0.45\textwidth]{6sp_tspd_seasons_c.png}}\hspace{0.05\textwidth}
  \subfloat[Swamp Wallaby]{\label{6sp_tspd_seas:d}\includegraphics[width=0.45\textwidth]{6sp_tspd_seasons_d.png}}\\
  \subfloat[Common Wombat]{\label{6sp_tspd_seas:e}\includegraphics[width=0.45\textwidth]{6sp_tspd_seasons_e.png}}\hspace{0.05\textwidth}
  \subfloat[Koala]{\label{6sp_tspd_seas:f}\includegraphics[width=0.45\textwidth]{6sp_tspd_seasons_f.png}}
