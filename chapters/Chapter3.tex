...
\begin{figure*}[htp]
  \centering
  \subfloat[]{\label{6sp_sac:a}\includegraphics[width=0.4\textwidth]{6sp_sac_a.png}}
  \subfloat[]{\label{6sp_sac:b}\includegraphics[width=0.4\textwidth]{6sp_sac_b.png}}\\
  \subfloat[]{\label{6sp_sac:c}\includegraphics[width=0.4\textwidth]{6sp_sac_c.png}}
  \subfloat[]{\label{6sp_sac:d}\includegraphics[width=0.4\textwidth]{6sp_sac_d.png}}\\
  \subfloat[]{\label{6sp_sac:e}\includegraphics[width=0.4\textwidth]{6sp_sac_e.png}}
  \subfloat[]{\label{6sp_sac:f}\includegraphics[width=0.4\textwidth]{6sp_sac_f.png}}
...
\begin{figure*}[htp]
  \centering
  \subfloat[]{\label{6sp_effects:a}\includegraphics[width=0.3\textwidth]{6sp_occ.png}
  \subfloat[]{\label{6sp_effects:b}\includegraphics[width=0.3\textwidth]{6sp_tvol.png}}
  \subfloat[]{\label{6sp_effects:c}\includegraphics[width=0.3\textwidth]{6sp_tspd.png}}
...
\begin{figure*}[htp]
  \centering
  \subfloat[]{\label{6sp_occ_seas:a}\includegraphics[width=0.4\textwidth]{6sp_occ_seasons_a.png}}
  \subfloat[]{\label{6sp_occ_seas:b}\includegraphics[width=0.4\textwidth]{6sp_occ_seasons_b.png}}\\
  \subfloat[]{\label{6sp_occ_seas:c}\includegraphics[width=0.4\textwidth]{6sp_occ_seasons_c.png}}
  \subfloat[]{\label{6sp_occ_seas:d}\includegraphics[width=0.4\textwidth]{6sp_occ_seasons_d.png}}\\
  \subfloat[]{\label{6sp_occ_seas:e}\includegraphics[width=0.4\textwidth]{6sp_occ_seasons_e.png}}
  \subfloat[]{\label{6sp_occ_seas:f}\includegraphics[width=0.4\textwidth]{6sp_occ_seasons_f.png}}
...
\begin{figure*}[htp]
  \centering
  \subfloat[]{\label{6sp_tvol_seas:a}\includegraphics[width=0.4\textwidth]{6sp_tvol_seasons_a.png}}
  \subfloat[]{\label{6sp_tvol_seas:b}\includegraphics[width=0.4\textwidth]{6sp_tvol_seasons_b.png}}\\
  \subfloat[]{\label{6sp_tvol_seas:c}\includegraphics[width=0.4\textwidth]{6sp_tvol_seasons_c.png}}
  \subfloat[]{\label{6sp_tvol_seas:d}\includegraphics[width=0.4\textwidth]{6sp_tvol_seasons_d.png}}\\
  \subfloat[]{\label{6sp_tvol_seas:e}\includegraphics[width=0.4\textwidth]{6sp_tvol_seasons_e.png}}
  \subfloat[]{\label{6sp_tvol_seas:f}\includegraphics[width=0.4\textwidth]{6sp_tvol_seasons_f.png}}
...
\begin{figure*}[htp]
  \centering
  \subfloat[]{\label{6sp_tspd_seas:a}\includegraphics[width=0.4\textwidth]{6sp_tspd_seasons_a.png}}
  \subfloat[]{\label{6sp_tspd_seas:b}\includegraphics[width=0.4\textwidth]{6sp_tspd_seasons_b.png}}\\
  \subfloat[]{\label{6sp_tspd_seas:c}\includegraphics[width=0.4\textwidth]{6sp_tspd_seasons_c.png}}
  \subfloat[]{\label{6sp_tspd_seas:d}\includegraphics[width=0.4\textwidth]{6sp_tspd_seasons_d.png}}\\
  \subfloat[]{\label{6sp_tspd_seas:e}\includegraphics[width=0.4\textwidth]{6sp_tspd_seasons_e.png}}
  \subfloat[]{\label{6sp_tspd_seas:f}\includegraphics[width=0.4\textwidth]{6sp_tspd_seasons_f.png}}
