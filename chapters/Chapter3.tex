...
\begin{figure*}[!h]
  ...
  \subfloat[Swamp Wallaby]{\label{6sp_occ_preds:d}\includegraphics[width=0.45\textwidth]{6sp_BSW_preds_brt.png}}\\  
...
\begin{figure*}[!t]
  \centering
  \subfloat[Eastern Grey Kangaroo]{\label{6sp_sac:a}\includegraphics[width=0.45\textwidth]{6sp_sac_a.png}}\hspace{0.5cm}
  \subfloat[Common Brushtail Possum]{\label{6sp_sac:b}\includegraphics[width=0.45\textwidth]{6sp_sac_b.png}}\\
  \subfloat[Common Ringtail Possum]{\label{6sp_sac:c}\includegraphics[width=0.45\textwidth]{6sp_sac_c.png}}\hspace{0.5cm}
  \subfloat[Swamp Wallaby]{\label{6sp_sac:d}\includegraphics[width=0.45\textwidth]{6sp_sac_d.png}}\\
  \subfloat[Common Wombat]{\label{6sp_sac:e}\includegraphics[width=0.45\textwidth]{6sp_sac_e.png}}\hspace{0.5cm}
...
All of the predictor variables demonstrated plausible relationships to collision likelihood in the partial dependency plots (\Cref{6sp_effects_occ,6sp_effects_tvol,6sp_effects_tspd}) and the signs of the coefficients were as expected (\Cref{6sp_sum_coll}). Further, these response shapes were similar across all seasons for each species except the two possums (\Cref{6sp_occ_seas,6sp_tvol_seas,6sp_tspd_seas}). Based on analysis of variation (ANOVA), species occurrence had the largest contribution to reduction in deviance for all of the models.

\begin{figure*}[!t]
  \centering
  %\includegraphics[width=\textwidth]{6sp_occ.png}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=.5cm]{egk_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_egk.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.55cm]{bsw_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_bsw.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.4cm]{wom_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_wom.png}}\\
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.55cm]{koa_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_koa.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.55cm]{btp_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_btp.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.55cm]{rtp_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_occ_a_rtp.png}}\\
  \stackinset{r}{-0.2cm}{t}{1cm}{\includegraphics[height=.5cm]{egk_icon_c.png}}{%
  \stackinset{r}{0.1cm}{b}{2.6cm}{\includegraphics[height=0.55cm]{bsw_icon_c.png}}{%
  \stackinset{r}{-0.1cm}{b}{4.6cm}{\includegraphics[height=0.4cm]{wom_icon_c.png}}{%
  \stackinset{r}{0.1cm}{b}{1.9cm}{\includegraphics[height=0.55cm]{koa_icon_c.png}}{%
  \stackinset{r}{0.9cm}{b}{3.2cm}{\includegraphics[height=0.55cm]{btp_icon_c.png}}{%
  \stackinset{r}{0.1cm}{b}{3.2cm}{\includegraphics[height=0.55cm]{rtp_icon_c.png}}{%
  \includegraphics[width=0.75\textwidth]{6sp_occ_a.png}%
  }}}}}}
  \caption[Marginal effect of species occurrence on relative likelihood of collision for six mammal species]{Marginal effect of species occurrence on relative likelihood of collision per species. An overall plot (below) shows relative collision rates for all species and six sub-panels (above) depict response shapes with rescaled collision risk (relative minimum to maximum) for each species. Species symbols are: \includegraphics[height=.45cm]{egk_icon_c.png} --`Eastern Grey Kangaroo'; \includegraphics[height=.5cm]{btp_icon_c.png} --`Common Brushtail Possum'; \includegraphics[height=.5cm]{rtp_icon_c.png} --`Common Ringtail Possum'; \includegraphics[height=.5cm]{bsw_icon_c.png} --`Swamp Wallaby'; \includegraphics[height=.35cm]{wom_icon_c.png} --`Wombat'; \includegraphics[height=.5cm]{koa_icon_c.png} --`Koala'.}
  \label{6sp_effects_occ}
\end{figure*}

\begin{figure*}[!t]
  \centering
  %\includegraphics[width=\textwidth]{6sp_tvol.png}
  \stackinset{r}{0.2cm}{t}{0.2cm}{\includegraphics[height=0.5cm]{egk_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tvol_b_egk.png}}
  \stackinset{r}{0.2cm}{t}{0.2cm}{\includegraphics[height=0.55cm]{bsw_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tvol_b_bsw.png}}
  \stackinset{r}{0.2cm}{t}{0.2cm}{\includegraphics[height=0.4cm]{wom_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tvol_b_wom.png}}\\
  \stackinset{r}{0.2cm}{t}{0.2cm}{\includegraphics[height=0.55cm]{koa_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tvol_b_koa.png}}
  \stackinset{r}{0.2cm}{t}{0.2cm}{\includegraphics[height=0.55cm]{btp_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tvol_b_btp.png}}
  \stackinset{r}{0.2cm}{t}{0.2cm}{\includegraphics[height=0.55cm]{rtp_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tvol_b_rtp.png}}\\
  \stackinset{r}{7.0cm}{t}{1.5cm}{\includegraphics[height=.5cm]{egk_icon_c.png}}{%
  \stackinset{r}{0.1cm}{b}{2.0cm}{\includegraphics[height=0.55cm]{bsw_icon_c.png}}{%
  \stackinset{r}{7.2cm}{b}{2.8cm}{\includegraphics[height=0.4cm]{wom_icon_c.png}}{%
  \stackinset{r}{0.1cm}{b}{1.3cm}{\includegraphics[height=0.55cm]{koa_icon_c.png}}{%
  \stackinset{r}{6.1cm}{b}{4.1cm}{\includegraphics[height=0.55cm]{btp_icon_c.png}}{%
  \stackinset{r}{5.8cm}{b}{3.0cm}{\includegraphics[height=0.55cm]{rtp_icon_c.png}}{%
  \includegraphics[width=0.75\textwidth]{6sp_tvol_b.png}%
  }}}}}}
  \caption[Marginal effect of traffic volume on relative likelihood of collision for six mammal species]{Marginal effect of traffic volume on relative likelihood of collision per species. An overall plot (below) shows relative collision rates for all species and six sub-panels (above) depict response shapes with rescaled collision risk (relative minimum to maximum) for each species. Species symbols are: \includegraphics[height=.45cm]{egk_icon_c.png} --`Eastern Grey Kangaroo'; \includegraphics[height=.5cm]{btp_icon_c.png} --`Common Brushtail Possum'; \includegraphics[height=.5cm]{rtp_icon_c.png} --`Common Ringtail Possum'; \includegraphics[height=.5cm]{bsw_icon_c.png} --`Swamp Wallaby'; \includegraphics[height=.35cm]{wom_icon_c.png} --`Wombat'; \includegraphics[height=.5cm]{koa_icon_c.png} --`Koala'.}
  \label{6sp_effects_tvol}
\end{figure*}

\begin{figure*}[!t]
  \centering
  %\includegraphics[width=\textwidth]{6sp_tspd.png}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.5cm]{egk_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tspd_c_egk.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.55cm]{bsw_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tspd_c_bsw.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.4cm]{wom_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tspd_c_wom.png}}\\
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.55cm]{koa_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tspd_c_koa.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.55cm]{btp_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tspd_c_btp.png}}
  \stackinset{r}{0.2cm}{b}{0.2cm}{\includegraphics[height=0.55cm]{rtp_icon_c.png}}{\includegraphics[width=0.25\textwidth]{6sp_tspd_c_rtp.png}}\\
  \stackinset{r}{-0.2cm}{t}{1cm}{\includegraphics[height=.5cm]{egk_icon_c.png}}{%
  \stackinset{r}{0.1cm}{b}{2.5cm}{\includegraphics[height=0.55cm]{bsw_icon_c.png}}{%
  \stackinset{r}{-0.1cm}{b}{3.1cm}{\includegraphics[height=0.4cm]{wom_icon_c.png}}{%
  \stackinset{r}{0.1cm}{b}{1.8cm}{\includegraphics[height=0.55cm]{koa_icon_c.png}}{%
  \stackinset{r}{7.6cm}{b}{2.5cm}{\includegraphics[height=0.55cm]{btp_icon_c.png}}{%
  \stackinset{r}{5.0cm}{b}{2.5cm}{\includegraphics[height=0.55cm]{rtp_icon_c.png}}{%
  \includegraphics[width=0.75\textwidth]{6sp_tspd_c.png}%
  }}}}}}
  \caption[Marginal effect of traffic speed on relative likelihood of collision for six mammal species]{Marginal effect of traffic speed on relative likelihood of collision per species. An overall plot (below) shows relative collision rates for all species and six sub-panels (above) depict response shapes with rescaled collision risk (relative minimum to maximum) for each species. Species symbols are: \includegraphics[height=.45cm]{egk_icon_c.png} --`Eastern Grey Kangaroo'; \includegraphics[height=.5cm]{btp_icon_c.png} --`Common Brushtail Possum'; \includegraphics[height=.5cm]{rtp_icon_c.png} --`Common Ringtail Possum'; \includegraphics[height=.5cm]{bsw_icon_c.png} --`Swamp Wallaby'; \includegraphics[height=.35cm]{wom_icon_c.png} --`Wombat'; \includegraphics[height=.5cm]{koa_icon_c.png} --`Koala'.}
  \label{6sp_effects_tspd}
\end{figure*}

Among species, the response of collision risk to occurrence likelihood demonstrated the least amount of variation in shape (\Cref{6sp_effects_occ}) compared to traffic volume (\Cref{6sp_effects_tvol}) and traffic speed (\Cref{6sp_effects_tspd}). Koalas had the highest increases in collision risk at lower values of occurrence likelihood and gradually reduced risk at higher values. This response was consistent for all species except ringtail possums which had an exponential relationship, albeit minor (coefficient of 1.08), between risk and occurrence.

\begin{figure*}[!t]
  \centering
  \subfloat[Eastern Grey Kangaroo]{\label{6sp_occ_seas:a}\includegraphics[width=0.47\textwidth]{6sp_occ_seasons_a.png}}\hspace{0.05\textwidth}
  \subfloat[Common Brushtail Possum]{\label{6sp_occ_seas:b}\includegraphics[width=0.47\textwidth]{6sp_occ_seasons_b.png}}\\
  \subfloat[Common Ringtail Possum]{\label{6sp_occ_seas:c}\includegraphics[width=0.47\textwidth]{6sp_occ_seasons_c.png}}\hspace{0.05\textwidth}
  \subfloat[Swamp Wallaby]{\label{6sp_occ_seas:d}\includegraphics[width=0.47\textwidth]{6sp_occ_seasons_d.png}}\\
  \subfloat[Common Wombat]{\label{6sp_occ_seas:e}\includegraphics[width=0.47\textwidth]{6sp_occ_seasons_e.png}}\hspace{0.05\textwidth}
  \subfloat[Koala]{\label{6sp_occ_seas:f}\includegraphics[width=0.47\textwidth]{6sp_occ_seasons_f.png}}
  \caption[Marginal effect of species occurrence on relative likelihood of collision for six mammal species by season]{Marginal effect of species occurrence on relative likelihood of collision for six mammal species by season.}
  \label{6sp_occ_seas}
\end{figure*}

\begin{figure*}[!t]
  \centering
  \subfloat[Eastern Grey Kangaroo]{\label{6sp_tvol_seas:a}\includegraphics[width=0.47\textwidth]{6sp_tvol_seasons_a.png}}\hspace{0.05\textwidth}
  \subfloat[Common Brushtail Possum]{\label{6sp_tvol_seas:b}\includegraphics[width=0.47\textwidth]{6sp_tvol_seasons_b.png}}\\
  \subfloat[Common Ringtail Possum]{\label{6sp_tvol_seas:c}\includegraphics[width=0.47\textwidth]{6sp_tvol_seasons_c.png}}\hspace{0.05\textwidth}
  \subfloat[Swamp Wallaby]{\label{6sp_tvol_seas:d}\includegraphics[width=0.47\textwidth]{6sp_tvol_seasons_d.png}}\\
  \subfloat[Common Wombat]{\label{6sp_tvol_seas:e}\includegraphics[width=0.47\textwidth]{6sp_tvol_seasons_e.png}}\hspace{0.05\textwidth}
  \subfloat[Koala]{\label{6sp_tvol_seas:f}\includegraphics[width=0.47\textwidth]{6sp_tvol_seasons_f.png}}
  \caption[Marginal effect of traffic volume on relative likelihood of collision for six mammal species by season]{Marginal effect of traffic volume on relative likelihood of collision for six mammal species by season.}
  \label{6sp_tvol_seas}
\end{figure*}

\begin{figure*}[!t]
  \centering
  \subfloat[Eastern Grey Kangaroo]{\label{6sp_tspd_seas:a}\includegraphics[width=0.47\textwidth]{6sp_tspd_seasons_a.png}}\hspace{0.05\textwidth}
  \subfloat[Common Brushtail Possum]{\label{6sp_tspd_seas:b}\includegraphics[width=0.47\textwidth]{6sp_tspd_seasons_b.png}}\\
  \subfloat[Common Ringtail Possum]{\label{6sp_tspd_seas:c}\includegraphics[width=0.47\textwidth]{6sp_tspd_seasons_c.png}}\hspace{0.05\textwidth}
  \subfloat[Swamp Wallaby]{\label{6sp_tspd_seas:d}\includegraphics[width=0.47\textwidth]{6sp_tspd_seasons_d.png}}\\
  \subfloat[Common Wombat]{\label{6sp_tspd_seas:e}\includegraphics[width=0.47\textwidth]{6sp_tspd_seasons_e.png}}\hspace{0.05\textwidth}
  \subfloat[Koala]{\label{6sp_tspd_seas:f}\includegraphics[width=0.47\textwidth]{6sp_tspd_seasons_f.png}}
  \caption[Marginal effect of traffic speed on relative likelihood of collision for six mammal species by season]{Marginal effect of traffic speed on relative likelihood of collision for six mammal species by season.}
  \label{6sp_tspd_seas}
\end{figure*}

All of the models had highly significant coefficients for both linear and quadratic terms of traffic volume.  All of the model fits demonstrated curvilinear responses to AADT with consistent peaks around 3,000--5,000 vehicles day$^{-1}$ for all species except the two possums which peaked between 9,000--12,000 vehicles day$^{-1}$. Between the two possums, collision risk peaked at higher values of AADT for the brushtail possum and did not increase or decrease as rapidly across all values of AADT.  Koalas and swamp wallabies had very similar response shapes and also showed the quickest rise and fall of collision risk between 0--10,000 vehicles day$^{-1}$ compared to all other species.
