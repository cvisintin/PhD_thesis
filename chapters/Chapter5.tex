...
\begin{figure*}[!h]
  ...
  \centering
  \subfloat[]{\label{train_crep:a}\includegraphics[width=0.45\textwidth]{05_crep01.png}}
  \subfloat[]{\label{train_crep:b}\includegraphics[width=0.45\textwidth]{05_crep29.png}}\\[.5cm]
  \subfloat[]{\label{train_crep:c}\includegraphics[width=0.45\textwidth]{05_crep24.png}}
  \subfloat[]{\label{train_crep:d}\includegraphics[width=0.45\textwidth]{05_crep26.png}}
...
\begin{figure*}[!t]
  ...
  \subfloat[]{\label{train_brq:b}\includegraphics[width=0.4\textwidth]{05_brq_egk.png}}\hspace{1cm}
  \subfloat[]{\label{train_brq:c}\includegraphics[width=0.4\textwidth]{05_brq_trains.png}}\\
  \subfloat[]{\label{train_brq:d}\includegraphics[width=0.4\textwidth]{05_brq_speed.png}}\hspace{1cm}
...
\begin{figure*}[!t]
  \captionsetup[subfloat]{farskip=-2pt,nearskip=-2pt}
  \centering
  \subfloat[]{\label{train_effects:a}\includegraphics[height=7.3cm]{05_speed.png}}\hspace{.75cm}
  \subfloat[]{\label{train_effects:b}\includegraphics[height=7.3cm]{05_egk2.png}}\\
  \subfloat[]{\label{train_effects:c}\includegraphics[height=7.3cm]{05_trains.png}}\hspace{.75cm}
  \subfloat[]{\label{train_effects:d}\includegraphics[height=7.3cm]{05_hour2.png}}
...
\begin{figure*}[!t]
  \captionsetup[subfloat]{farskip=-2pt,nearskip=-2pt}
  \centering
  \subfloat[]{\label{train_calib:a}\includegraphics[height=6cm]{05_calib2.png}}\\
  \subfloat[]{\label{train_calib:b}\includegraphics[height=6cm]{05_roc.png}}\hspace{1cm}
  \subfloat[]{\label{train_calib:c}\includegraphics[height=6cm]{05_validate.png}}
